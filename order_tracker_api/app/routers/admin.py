    ...
    try:
        ...
        for order_data in orders_data:
            ...
            if existing_order:
                ...
                existing_order.agent_code = str(order_data.get("agent_id", "") or "")
                ...
                new_order = Order(
                    ...
                    agent_code=str(order_data.get("agent_id", "") or ""),
    ...
    try:
        ...
        for bill_data in bills_data:
            ...
            bill = OutstandingBill(
                ...
                bill_date=datetime.fromisoformat(bill_data["bill_date"]).date() if bill_data.get("bill_date") else None,
